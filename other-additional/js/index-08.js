...
document.getElementById('filterBtn').addEventListener("click", getAdditionalList);
...
function individualAdditional(){
    ...
    let type_of_addition = $('#add-type-of-addition').val();

    if(employee_id == '' || amount == '' || type_of_addition.trim() == ''){
        swal.fire({
            icon: 'info',   
    ...
    formdata.append("type_of_addition", type_of_addition);
            ...
            $.ajax({
                ...
                // success: function (response) {
                    ...
                    if(response.success == 1){
                        ...
                        swal.fire({
                            icon: 'success',   
                            title: 'Successfully Deleted Additional! '        
                        }).then(function (result) {
                            getAdditionalList()
                        });
        ...
        success: function(response){
            if(response.success == 1){
                if(response.data.length > 0){
                    ...
                    buttonArray = [
                        {
                            text: '<i class="bx bx-plus"></i> Add Additional',
