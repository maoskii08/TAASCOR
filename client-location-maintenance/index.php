...
<head>
  ...
  <title>Client Location Maintenance</title>
            ...
            <div class="navbar-nav align-items-center">
              <div class="nav-item d-flex align-items-center">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page">Client Location Maitenance</li>
                  </ol>
                </nav>
              </div>
            </div>
              ...
              <div class="row">
                  <div class="col-sm-12">
                    <button class="btn btn-md btn-primary" data-bs-toggle="modal"
                      ...
                      <i class='bx bx-plus me-1'></i> Client Location
                    </button>
                  </div>
                </div>
      ...
      <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Client Location Details</h5>
          ...
          <div class="modal-body" >
            <div class="row">
              <div class="col-sm-12">
                  ...
                  <div class="col-sm-12">
                    <div class="divider text-start">
                      <div class="divider-text">
                        <small class="text-uppercase fw-bold">Client Location Information</small>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-sm-4">
                    <label class="modal-label mt-2">Client Location Name:</label>
                  </div>
                  <div class="col-sm-8">
                    <input id="add-client-location" type="text" class="form-control">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <input id="edit-client-location" type="text" class="form-control">
                  </div>
                </div>
              </div>
            </div>
