...
class Data
{
    ...
    public function getIncompleteDetails(){
        ...
        try {
            ...
            $sql = "SELECT a.employee_id, a.full_name, branch_name, client_name, location_name as client_location, employee_type
                    ...
                    and employee_type not in ('Seasonal','Long Term') and a.status = 'Active'
