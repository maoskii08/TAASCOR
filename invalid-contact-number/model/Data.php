...
class Data
{
    ...
    public function getIncompleteDetails(){
        ...
        try {
            ...
            $sql = "SELECT a.employee_id, a.full_name, branch_name, client_name, location_name as client_location, contact_number
                    FROM employee_list a
                    INNER JOIN employee_details w on a.employee_id = w.employee_id
                    ...
                    where contact_number NOT REGEXP '^[0-9]{11}$' and a.status = 'Active'
