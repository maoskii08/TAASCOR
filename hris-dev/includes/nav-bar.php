...
?>
<!-- ⚠️ DEV ENVIRONMENT BANNER -->
<div style="
    position:fixed; top:0; left:0; right:0; z-index:99999;
    background:#d32f2f; color:#fff; text-align:center;
    padding:6px 12px; font-size:13px; font-weight:600;
    letter-spacing:.5px; box-shadow:0 2px 6px rgba(0,0,0,.3);">
    ⚠️ DEVELOPMENT ENVIRONMENT (hris-dev) — Changes here use the DEV database.
    Do NOT use real employee data. &nbsp;|&nbsp;
    <a href="/hris/" style="color:#ffeb3b; text-decoration:underline;">Switch to Production →</a>
</div>
<div style="height:36px;"></div><!-- push content below banner -->
...
<nav id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme sidebar">
        ...
        <ul class="menu-inner py-3" id="side-ul">
          <input hidden type="text" id="url_page" value="<?php echo $pathParts[6];?>"></input>
          <input hidden type="text" id="access_level" value="<?php echo $_SESSION['taascor_access_level'];?>"></input>
