            ...
            <div class="navbar-nav align-items-center">
              <div class="nav-item d-flex align-items-center">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page">Department Maintenance</li>
                  </ol>
                </nav>
              </div>
            </div>
              ...
              <div class="row">
                  <div class="col-sm-12">
                    <button class="btn btn-md btn-primary" data-bs-toggle="modal"
                      ...
                      <i class='bx bx-plus me-1'></i> Department
                    </button>
                  </div>
                </div>
          ...
          <div class="modal-body" >
            <div class="row">
              <div class="col-sm-12">
                  ...
                  <div class="col-sm-12">
                    <div class="divider text-start">
                      <div class="divider-text">
                        <small class="text-uppercase fw-bold">Department Information</small>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-sm-4">
                    <label class="modal-label mt-2">Department Name:</label>
                  </div>
                  <div class="col-sm-8">
                    <input id="add-department-name" type="text" class="form-control">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <input id="edit-department-name" type="text" class="form-control">
                  </div>
                </div>
              </div>
            </div>
