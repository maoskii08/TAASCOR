...
class Data
{
    ...
    public function getIncompleteDetails(){
        ...
        try {
            ...
            $sql = "SELECT a.employee_id, a.full_name, branch_name, client_name, location_name as client_location, sss_number
                    ...
                    where LENGTH(REGEXP_REPLACE(sss_number, '[^0-9]', '')) != 10 
                    and sss_number is not null and trim(sss_number) != '' and a.status = 'Active'
